...
handles_lines = ''			# variable to contain the lines from the CSV file containing the 003/001 values and corresponding URL handles
...
recs_final_rnd_count = 0			# total records passing errors criteria and saving to "final" version for this round of analysis/updates
